            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16">
                <div className="lg:col-span-7 flex flex-col gap-8">
                    ...
                    <p className="text-lg md:text-xl text-primary font-body leading-relaxed text-justify hyphens-auto">
                        ...
                        <span className="font-bold">ohammad Minhazul Abedin </span> is a Software Engineer and CS graduate (<span className="font-bold underline decoration-[3px] underline-offset-4 decoration-accent font-mono text-sm">CGPA 3.73/4.00</span>) from Bangladesh who builds products that matter—from a real-time Android bus-tracking system used by 500+ daily commuters, to full-stack web platforms powering real workflows.
                    </p>
